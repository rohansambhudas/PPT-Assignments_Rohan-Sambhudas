...
function countStudents(students, sandwiches) {
    ...
    const sandwichQueue = [...sandwiches];
  
    while (studentQueue.length > 0 && sandwichQueue.length > 0) {
      if (studentQueue[0] === sandwichQueue[0]) {
        studentQueue.shift();
        sandwichQueue.shift();
      } else {
        const frontStudent = studentQueue.shift();
  ...
  console.log(countStudents(students1, sandwiches1)); // Output: 0
